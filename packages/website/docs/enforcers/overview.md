...
As long as the verifying contract inherits from `Delegatable`, developerds can focus on what they do best, and write their own, custom made enforcers for their Dapps. 
